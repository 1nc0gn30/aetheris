...
Next-generation GUI interfaces for orchestrating AI agent employees. Featuring Dev, Orchestrator, and Customer views.
...
### 📦 Installation
```bash
git clone https://github.com/1nc0gn30/aetheris.git
cd aetheris
npm install
```
...
View your app in AI Studio: https://ai.studio/apps/d5bb6791-7b05-4eb9-9cf3-524f4b86c260
...
1. Install dependencies:
   `npm install`
2. BYOK mode: add your own Gemini API key in the app settings or key field (stored in browser localStorage).
3. Run the app:
   `npm run dev`
# aetheris
...
## 🔗 Links
- GitHub: https://github.com/1nc0gn30/aetheris
